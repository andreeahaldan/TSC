...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -g/top/test/TEST_NAME=$1 -g/top/test/NO_OF_TRANS=$2  -g/top/test/TYPE_OF_TRANSACTION=$3 -g/top/test/SEED=$4 top
